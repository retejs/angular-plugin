import { Component, Input, OnInit, ChangeDetectorRef, OnChanges, ViewContainerRef, ComponentRef } from '@angular/core';
...
export class ConnectionWrapperComponent implements OnInit, OnChanges{
  ...
  constructor(private cdr: ChangeDetectorRef, public viewContainerRef: ViewContainerRef)  {
    this.cdr.detach()
  }
  ...
  ngOnInit() {
    ...
    this.ref = this.viewContainerRef.createComponent(this.connectionComponent);
    this.update()
  }
